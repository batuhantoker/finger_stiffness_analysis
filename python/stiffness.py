...
ranges={}
color_list=['red','black','yellow','black','yellow','black','yellow','black','yellow','black','yellow','black','yellow','black','yellow','black','yellow','black','yellow','black','yellow',]
label_list=['rest','Little\nfinger:\n flex','Little\nfinger:\n extend','Ring\nfinger:\n flex','Ring\nfinger:\n extend','Middle\nfinger:\n flex','Middle\nfinger:\n extend','Index\nfinger:\n flex','Index\nfinger:\n extend','Thumb:\n down','Thumb:\n up','Thumb:\n left','Thumb:\n right']
force_labels=['index', 'middle','ring','little','thumb\nleft/right','thumb \nup/down']
finger_1=3
...
for i in np.unique(movement_id):
    ...
    ax2[0].axvspan(int(ranges[i][0][0]), int(ranges[i][0][-1]), alpha=0.1, color=color_list[np.where(np.unique(movement_id)==i)[0][0]])
